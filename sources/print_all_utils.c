...
/*   Updated: 2024/09/09 18:01:15 by akinzeli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_all(t_scene *scene)
{
	...
	printf("Camera position: %f %f %f\n", scene->cam->pos.x, scene->cam->pos.y,
		scene->cam->pos.z);
	printf("Camera direction: %f %f %f\n", scene->cam->dir.x, scene->cam->dir.y,
		scene->cam->dir.z);
	printf("Camera fov: %d\n", scene->cam->fov);
